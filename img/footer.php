<?php include 'modalGracias.php'; ?>
<div id="mensajeEmail" style="display:none;">
        ...
        <div id="gmapa" style="width: 75%;/*float:left*/;margin-top: 150px;margin-left: 0px/*-185px*/;height:240px;"></div>
         <div class="social-icons">
          <ul class="footersociallinks">
            ...
            <!-- <li><a href="https://www.facebook.com/Mobillerscompany" target="_blank"><img src="img/footer_link_1.png" class="img-responsive" /></a></li>
            <li><a href="https://twitter.com/mobillers" target="_blank"><img src="img/footer_link_2.png" class="img-responsive" /></a></li>
            <li><a href="https://www.instagram.com/?hl=es-la" target="_blank"><img src="img/footer_link_4.png" class="img-responsive" /></a></li>
            <li><a href="https://www.linkedin.com/company/mobillers" target="_blank"><img src="img/footer_link_5.png" class="img-responsive" /></a></li> -->
          </ul>
        </div>
